...
module.exports={
     ...
     */
    get_articles_from_search(keyword, type_search, offset, premium){
        ...
        order by a.is_premium DESC, a.article_id ASC
     ...
     */
    count_result_from_search(keyword, type_search, premium){
